...
def calculate_lyrics_stats(artist: str, interactive: bool, api: Api, silent: bool = False,
...
def run(args: List[str], file=sys.stdout, api: Api = Api()) -> None:
    ...
    word_counts, song_count = calculate_lyrics_stats(args.artist, args.interactive, api, output_pipe=file)
